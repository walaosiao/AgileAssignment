<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddStaff.aspx.cs" Inherits="CRUD.Customer.Staff.AddStaff" %>
...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:busConn %>" SelectCommand="SELECT * FROM [staff]"></asp:SqlDataSource>
